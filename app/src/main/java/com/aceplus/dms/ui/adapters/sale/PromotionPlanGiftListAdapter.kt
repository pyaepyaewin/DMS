...
class PromotionPlanGiftListAdapter :
    BaseRecyclerViewAdapter<PromotionPlanGiftViewHolder, Customer>() {
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): PromotionPlanGiftViewHolder {
        val view =
            LayoutInflater.from(p0.context).inflate(R.layout.list_row_promotion, p0, false)
