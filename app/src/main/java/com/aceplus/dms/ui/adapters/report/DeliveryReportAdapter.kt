...
class DeliveryReportAdapter(private val onClick: (invoiceId: String) -> Unit):BaseRecyclerViewAdapter<DeliveryReportViewHolder,DeliverReport>() {
    ...
    return DeliveryReportViewHolder(view,onClick)
    }
}