...
class SaleCancelDetailReportViewHolder(private val view: View):BaseViewHolder<SaleCancelInvoiceDetailReport>(view) {
    override fun setData(data: SaleCancelInvoiceDetailReport) {
        view.apply {
