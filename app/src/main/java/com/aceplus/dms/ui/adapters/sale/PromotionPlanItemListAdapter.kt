...
//class PromotionPlanItemListAdapter :
//    BaseRecyclerViewAdapter<PromotionPlanItemViewHolder, Customer>() {
//    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): PromotionPlanItemViewHolder {
//        val view =
//            LayoutInflater.from(p0.context).inflate(R.layout.list_row_sold_product_with_custom_discount, p0, false)
//        return PromotionPlanItemViewHolder(view)
//    }
//}