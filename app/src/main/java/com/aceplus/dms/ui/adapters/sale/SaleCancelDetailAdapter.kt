...
class SaleCancelDetailAdapter(
    ...
    private val onLongClickSoldProductListItem: (data: SoldProductInfo, position: Int) -> Unit
) : BaseRecyclerViewAdapter<SaleCancelDetailViewHolder, SoldProductInfo>() {
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): SaleCancelDetailViewHolder {
        ...
        return SaleCancelDetailViewHolder(view, onClickQtyButton,onLongClickSoldProductListItem)
