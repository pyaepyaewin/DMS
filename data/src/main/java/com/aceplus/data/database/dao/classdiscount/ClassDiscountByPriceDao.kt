...
interface ClassDiscountByPriceDao {
    ...
    @Query("select class_discount_by_price.discount_type,class.name,class_discount_by_price_item.from_quantity,class_discount_by_price_item.to_quantity,class_discount_by_price_item.from_amount,class_discount_by_price_item.to_amount,class_discount_by_price_item.discount_percent from class_discount_by_price_item,class,class_discount_by_price where class_discount_by_price.discount_type='P' and class_discount_by_price_item.class_discount_id=class_discount_by_price.id and class.class_id=class_discount_by_price_item.class_id")
