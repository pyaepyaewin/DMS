...
interface TempForSaleManRouteDao {
    ...
    fun updateArrivalAndDepartureTime(saleManId: String, customerId: Int, currentDate: String)
    ...
    fun updateDepartureTime(saleManId: String, customerId: Int, currentDate: String)
