...
interface PromotionGiftDao{
    ...
    fun deleteAll()
    @Query("select product.product_name,promotion_gift.from_quantity,promotion_gift.to_quantity,promotion_gift_item.quantity from product, promotion_gift, promotion_gift_item where promotion_gift_item.promotion_plan_id=promotion_gift.promotion_plan_id and product.id=promotion_gift_item.stock_id")
