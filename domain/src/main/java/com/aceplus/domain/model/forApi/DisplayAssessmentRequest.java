...
public class DisplayAssessmentRequest {

    @SerializedName("data")
    @Expose
    private List<DisplayAssessmentData> data = null;
    ...
    public List<DisplayAssessmentData> getData() {
        return data;
    }

    public void setData(List<DisplayAssessmentData> data) {
        this.data = data;
    }
