...
public class ClassDiscountPriceForApi {
    ...
    @SerializedName("ClassDiscountByPriceItem")
    @Expose
    private List<ClassDiscountByPriceItem> classDiscountByPriceItems = null;

    @SerializedName("ClassDiscountByPriceGift")
    @Expose
    private List<ClassDiscountByPrice_Gift> classDiscountByPriceGifts = null;
    ...
    public List<ClassDiscountByPriceItem> getClassDiscountByPriceItems() {
        return classDiscountByPriceItems;
    }

    public void setClassDiscountByPriceItems(List<ClassDiscountByPriceItem> classDiscountByPriceItems) {
        this.classDiscountByPriceItems = classDiscountByPriceItems;
    }

    public List<ClassDiscountByPrice_Gift> getClassDiscountByPriceGifts() {
        return classDiscountByPriceGifts;
    }

    public void setClassDiscountByPriceGifts(List<ClassDiscountByPrice_Gift> classDiscountByPriceGifts) {
