...
@Entity(tableName = "route_schedule_item_v2")
class RouteScheduleItemV2 {
    ...
    @ColumnInfo(name = "route_schedule_id")
    @SerializedName("route_schedule_id")
    @Expose
    var route_schedule_id: Int = 0
